...
<?php if ($page): ?>
  <iframe width="560" height="315" src="http://mws.all4senses.com/mws/catalog" frameborder="0"></iframe>
<?php endif; ?>
...
<?php endif; ?>
  ...
  $url = 'http://park.all4senses.com' . ($_SERVER['REQUEST_URI'] == '/home' ? '/' : $_SERVER['REQUEST_URI']);
